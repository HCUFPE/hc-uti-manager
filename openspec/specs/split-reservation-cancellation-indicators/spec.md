# split-reservation-cancellation-indicators Specification

## Purpose
TBD - created by archiving change split-reservation-cancellation-indicators. Update Purpose after archive.
## Requirements
