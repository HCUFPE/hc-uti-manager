...
def main():
    ...
    try:
        ...
        # Buscar todos os alertas cadastrados para os prontuários 22064729 e 21931076
        query = "select id, titulo, lido, lido_por, criado_em, mensagem from alertas where prontuario in ('22064729', '21931076');"
