...
def main():
    ...
    try:
        ...
        # Obter os nomes associados aos prontuários 22064729 e 21931076
        query = "select prontuario, nome from solicitacoes_leito where prontuario in ('22064729', '21931076');"
