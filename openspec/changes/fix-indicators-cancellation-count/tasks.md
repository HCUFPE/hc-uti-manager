...
- [x] 1.1 Atualizar os filtros de tipo de ação no arquivo `src/providers/implementations/indicadores_provider.py` para mapear `"exclusao_solicitacao"` e `"cancelamento_reserva"`.
