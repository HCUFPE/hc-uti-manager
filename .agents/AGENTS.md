...
1. **Análise de Impacto de Novas Funcionalidades:**
   * Sempre que for solicitada a criação de uma nova funcionalidade, nova tela, nova API ou mudança em regras de negócio, o agente **DEVE** obrigatoriamente abrir e analisar os arquivos de especificação de concepção localizados na pasta [docs/projeto_inicial/](./docs/projeto_inicial/) e o [README.md](./README.md) principal antes de fazer qualquer alteração no código.
