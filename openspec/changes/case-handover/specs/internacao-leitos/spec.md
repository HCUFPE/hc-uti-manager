...
O sistema MUST gerenciar o fluxo visual e a autorização de transferência de pacientes com leito de UTI reservado pós-cirúrgico, exigindo confirmação de passagem de caso quando fornecida pelo Bloco Cirúrgico.
...
- **WHEN** o usuário da UTI clica em "Liberar Encaminhamento" no card do leito e aceita a passagem de caso (se houver)
