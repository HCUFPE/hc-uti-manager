...
def main():
    ...
    try:
        ...
        query = "select id, tipo, acao, criado_em, detalhes from historico_acoes where criado_em >= '2026-07-29 00:00:00' and (detalhes like '%troca%' or detalhes like '%substitu%' or detalhes like '%21036074%');"
