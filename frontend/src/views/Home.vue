    ...
    <div class="flex flex-wrap items-center justify-between gap-3">
      ...
      <div class="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          :class="uiStore.isMuted ? 'border-red-200 bg-red-50 text-red-600 hover:bg-red-100' : 'border-slate-200 bg-white text-slate-700 hover:bg-slate-50'"
          @click="uiStore.toggleMute"
          :title="uiStore.isMuted ? 'Ativar alerta sonoro' : 'Desativar alerta sonoro'"
        >
          <template v-if="uiStore.isMuted">
