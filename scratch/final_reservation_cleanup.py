...
async def cleanup():
    ...
    async for session in db.get_session():
        ...
        print(f"Deletando alertas antigos para prontuários: {prontuarios_troca}")
        await session.execute(
            delete(Alerta).where(Alerta.prontuario.in_(prontuarios_troca))
        )
        
        # 2. Criar o alerta de remanejamento correto para a primeira troca (Heloísa)
        print("Criando alerta unificado para a troca -> 22307987 (Heloísa)...")
        alerta_1 = Alerta(
            tipo="aviso",
            categoria="Gargalo",
        ...
        # 3. Criar o alerta de remanejamento correto para a segunda troca (13938907)
        ...
        print("Limpeza final de alertas de trocas executada com sucesso!")
